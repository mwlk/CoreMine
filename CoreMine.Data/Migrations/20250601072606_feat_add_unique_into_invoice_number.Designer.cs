...
namespace CoreMine.Data.Migrations
{
    ...
    [Migration("20250601072606_feat_add_unique_into_invoice_number")]
    partial class feat_add_unique_into_invoice_number
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoreMine.Data.ReadModels.CategoryWithFullCodeReadModel", b =>
                {
                    b.Property<string>("Code")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("FullCategoryCode")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToView("vw_CategoriesWithFullCode", (string)null);
                });

            modelBuilder.Entity("CoreMine.Data.ReadModels.ProductsWithFullCategoryInfoReadModel", b =>
                {
                    ...
                    b.Property<int?>("LastStateTypeId")
                        .HasColumnType("int");

                    b.Property<string>("LastStateTypeName")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToView("vw_ProductsWithFullCategoryInfo", (string)null);
                });

            modelBuilder.Entity("CoreMine.Data.ReadModels.RepairWithProductsReadModel", b =>
                {
                    ...
                    b.Property<bool>("MachineIsActive")
                        .HasColumnType("bit");
                    ...
                    b.ToView("vw_RepairsWithProducts", (string)null);
                });
            ...
            modelBuilder.Entity("CoreMine.Entities.PurchaseInvoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("IngresedAt")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("PurchasInvoices", (string)null);
                });

            modelBuilder.Entity("CoreMine.Entities.PurchaseInvoiceDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CoreMine.Entities.PurchaseInvoiceDetail", b =>
                {
                    ...
                    b.HasOne("CoreMine.Entities.PurchaseInvoice", "PurchaseInvoice")
                        .WithMany("PurchaseInvoiceDetails")
